...
| `machines/mandel/COMMISSIONING.md` | **Field commissioning procedure for MANDEL** — 21 steps in five phases for an engineer on site: measure the true build volume (the config contradicts itself and Y is unsafe), correct `printer.cfg`, set up PrusaSlicer, and run an acceptance print. Includes a data sheet and a triage table |
